...
public sealed class SpoilerInlineParser : InlineParser
{
    ...
    public override bool Match(InlineProcessor processor, ref StringSlice slice)
    {
        ...
        {
            Span = new(processor.GetSourcePosition(startPosition, out var line, out var column), processor.GetSourcePosition(slice.Start - 1)),
            Line = line,
            Column = column,
            Content = new(content)
        };
