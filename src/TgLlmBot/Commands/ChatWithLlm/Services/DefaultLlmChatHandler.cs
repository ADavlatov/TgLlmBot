...
public partial class DefaultLlmChatHandler : ILlmChatHandler
{
    ...
    private ChatMessage BuildSystemPrompt()
    {
        ...
        return new(
             ...
             *   **Если в запросе есть фраза «объясни для кверти»**, отвечай максимально простым детским языком, «на собачках», без жаргона, с пошаговыми объяснениями и примерами из повседневной жизни, как для ребёнка; если фразы нет — отвечай в обычном техническом стиле для .NET-разработчиков.
